...
| `z-image-uncensored` | <Badge color="green" shape="pill">Live</Badge> | Z Image Uncensored | `prompt`, `model` | common + `seed`, `prompt_extend`; dimensions 256-1,536 px (default 1,024×1,536) | `$0.10` | ~20s |
